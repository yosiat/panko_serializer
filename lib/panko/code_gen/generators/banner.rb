...
module SerializersCodeGen
  module Generators
    ...
    module Banner
      ...
      # first +class+ line (emitted by the caller's per-class loop).
      # Emits the leading +#+-only separator, the +Generated by+ /
      # +Descriptor:+ / +Mode:+ / +Config:+ identification block, the
      # second +#+-only separator, the +# To use:+ example block, and a
      # trailing blank line — eleven source lines including the pragma
