...
benchmark_ams "Attributes_Include", AmsPostWithHasOneFastSerializer, include: [:id, :body, :author_id, :author]
...
benchmark_ams "JsonAPI_Include", AmsPostWithHasOneFastSerializer, include: [:id, :body, :author_id, :author]
