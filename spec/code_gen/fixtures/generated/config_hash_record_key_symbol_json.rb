...
# Mode: :json
# Config: null_for_missing_has_one=true, supports_root_key=false, hash_record_key_type=:symbol, hash_output_key_type=:string, json_column_emit=:wire_format, pool_writer=true, guarded_model=false
#
# To use:
...
class ConfigHashRecordKeySymbolSerializer_JSON
  ...
  POOL = Panko::CodeGen::WritersPool::IsolatedExecutionState.new(:_scg_writer__ConfigHashRecordKeySymbolSerializer_JSON)
