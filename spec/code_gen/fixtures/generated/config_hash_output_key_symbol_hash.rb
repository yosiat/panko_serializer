...
# Mode: :hash
# Config: null_for_missing_has_one=true, supports_root_key=false, hash_record_key_type=:string, hash_output_key_type=:symbol, json_column_emit=:wire_format, pool_writer=true
#
# To use:
