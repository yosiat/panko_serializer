  ...
  describe "with Config#pool_writer: false" do
    ...
    it "emits the pre-pooling shallow_generic source verbatim" do
      ...
      expected = <<~RUBY
        ...
        # Mode: :json
        # Config: null_for_missing_has_one=true, supports_root_key=false, hash_record_key_type=:string, hash_output_key_type=:string, json_column_emit=:wire_format, pool_writer=false
        #
        # To use:
